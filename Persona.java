...
public class Persona {
 ...
 public Persona() {
 // System.out.println("SE ESTÃ� EJECUTANDO EL CONSTRUCTOR POR
DEFECTO, "PORQUE SI!!!!!!!");
 }
...
edad) {
 ...
 return this.edad - p.edad; //p2.edad - p3.edad
////// p3.edad - p2.edad
 }
 public void imprime() {
...
apellidos=" + this.apellidos + ", dni=" + this.dni + ", edad=" +
this.edad + '}';

 }


 // Funcion que recibe un DNI y devuelve si es valido o no. OJO no
comprueba que la letra sea correcta!
 public static boolean validarDNI(String valor) {
 // Expresion regular que indica 8 digitos y al final alguna de
las letras que se permiten
